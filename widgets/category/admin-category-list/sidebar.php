    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input data-cy="category-settings-form-title" class="form-control" name="<?= TITLE ?>" value="<?= $category->title ?>">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input data-cy="category-settings-form-description" class="form-control" name="<?= DESCRIPTION ?>" value="<?= $category->description ?>">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input type="radio" name="returnToAfterPostEdit" value="V" <?php if ($category->returnToAfterPostEdit == 'V' || empty($category->returnToAfterPostEdit)) echo 'checked' ?>> <?= ek('Post view page', '글 읽기 페이지') ?>,
                    </label>
                    &nbsp;
                    <label>
                        <input type="radio" name="returnToAfterPostEdit" value="L" <?php if ($category->returnToAfterPostEdit == 'L') echo 'checked' ?>> <?= ek('Post list page', '글 목록 페이지') ?>
                    </label>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <label>
                        <input type="radio" name="listOnView" value="Y" <?php if ($category->listOnView == 'Y') echo 'checked' ?>> <?= ek('Yes', '예') ?>,
                    </label>
                    &nbsp;
                    <label>
                        <input type="radio" name="listOnView" value="N" <?php if ($category->listOnView != 'Y') echo 'checked' ?>> <?= ek('No', '아니오') ?>
                    </label>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input class="form-control" name="noOfPostsPerPage" type="text" value="<?= $category->noOfPostsPerPage ?>">
                </td>
            </tr>
            <tr>
                <td nowrap><?= ek('No of pages on navigator', '네이게이션 페이지 수') ?></td>
                <td>
                    <input class="form-control" name="noOfPagesOnNav" type="text" value="<?= $category->noOfPagesOnNav ?>">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <label class="">
                        <input type="radio" name="mobilePostListWidget" value="text" <?php if ($category->mobilePostListWidget == 'text') echo 'checked' ?>> <?= ek('Text', '텍스트') ?>
                    </label>
                    <label class="ps-2">
                        <input type="radio" name="mobilePostListWidget" value="gallery" <?php if ($category->mobilePostListWidget == 'gallery') echo 'checked' ?>> <?= ek('Gallery', '갤러리') ?>
                    </label>

                    <label class="ps-2">
                        <input type="radio" name="mobilePostListWidget" value="thumbnail" <?php if ($category->mobilePostListWidget == 'thumbnail') echo 'checked' ?>> <?= ek('Thumbnail', '썸네일') ?>
                    </label>
            ...
            <tr>
                ...
                <td>
                    <label class="">
                        <input type="radio" name="mobilePostViewWidget" value="default" <?php if ($category->mobilePostViewWidget == 'default') echo 'checked' ?>> <?= ek('Default', '기본') ?>
                    </label>
                    <label class="ps-2">
                        <input type="radio" name="mobilePostViewWidget" value="slide" <?php if ($category->mobilePostViewWidget == 'slide') echo 'checked' ?>> <?= ek('Slide', '슬라이드') ?>
                    </label>
