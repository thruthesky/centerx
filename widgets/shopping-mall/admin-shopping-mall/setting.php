...
<section id="app">
    ...
    <form method="post" action="/">
        ...
        <div class="mb-3">
            ...
            <div id="emailHelp" class="form-text">총 결제 금액이 {{ deliveryFeeFreeLimit }}원 이상이면 무료입니다.</div>
        </div>
        <div class="mb-3">
            ...
            <div id="emailHelp" class="form-text">총 결제 금액이 {{ deliveryFeeFreeLimit }}원 미만인 경우, 배송비가 {{ deliveryFeePrice }}원입니다.</div>
        </div>
