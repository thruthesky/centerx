...
<div class="container">
    <div class="row">
        <div class="col-3">
            <h3>Shopping Mall</h3>
            <ul>
                <li><a href="/?p=admin.index&w=shopping-mall/admin-shopping-mall&cw=shopping-mall/admin-shopping-mall-list">상품 목록</a></li>
                <li><a href="/?p=admin.index&w=shopping-mall/admin-shopping-mall&cw=shopping-mall/admin-shopping-mall-edit">상품 추가</a></li>
                ...
                <li><a href="/?p=<?=in('p')?>&w=<?=in('w')?>&cw=<?=in('w')?>-setting">설정</a></li>
            </ul>
        </div>
        <div class="col-9">
            <?php
