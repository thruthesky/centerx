...
<div class="container">
    <div class="row">
        <div class="col-3">
            <h3>Shopping Mall</h3>
            <ul>
                <li><a href="/?p=admin.index&w=shopping-mall/admin-shopping-mall&s=list">상품 목록</a></li>
                <li><a href="/?p=admin.index&w=shopping-mall/admin-shopping-mall&s=edit">상품 추가</a></li>
                ...
                <li><a href="/?p=<?=in('p')?>&w=<?=in('w')?>&s=setting">설정</a></li>
                <li><a href="/?p=<?=in('p')?>&w=<?=in('w')?>&s=order-list">주문 관리</a></li>
            </ul>
        </div>
        <div class="col-9">
<?php
