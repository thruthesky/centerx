    ...
    <div class="row">
        ...
        <div class="col-9">
            ...
            <form method="post" action="/">
                ...
                <div class="hint">
                    <?=ek("Site name that will be shown as browser title. Do not input special charachters.",
                ...
                <div>
                    ...
                    <div class="hint">
                        <?=ek("Input categories to be searched. If it is unset, all categories will be searched.",
