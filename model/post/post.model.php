...
//        $rows = db()->get_results($q, ARRAY_A);
     ...
     *
     * 참고, 코멘트는 처음의 1개만 리턴한다. 하지만, search 옵션에서 comment 갯수를 지정한 경우, 마지막에서 몇 개를 가져올지 지정할 수 있는데,
     *  search 옵션에서 comment 갯 수를 1 로 하면, 맨 마지막 글 1개만 가져오므로, 결국은 맨 마지막 글 1개만 리턴하는 것이 된다.
     *
     * @param array $got
     * @return array
     */
