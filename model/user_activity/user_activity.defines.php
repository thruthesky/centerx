...
class ActivityLimits {
    ...
    public static string $postCreateLimit = "postCreateLimit";
    public static string $commentCreateLimit = 'commentCreateLimit';
    public static string $readLimit = 'readLimit';
}
