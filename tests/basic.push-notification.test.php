...
errorTestUpdateTokenWithMultipleTopics();
...
function testSaveToken() {
    ...
    isTrue(  $re[DEFAULT_TOPIC] == true, 'success with default topic must be true: ' . DEFAULT_TOPIC);
}
...
function testUpdateToken() {
    ...
    isTrue( $token1[DEFAULT_TOPIC] == true, "defaultTopic was created");
...
function testUpdateTokenWithMultipleTopics()
{
    ...
    isTrue($re[$topic1] == true, 'must be true: ' . $topic1);
    isTrue($re[$topic2] == true, 'must be true: ' . $topic2);
    isTrue($re[$topic3] == true, 'must be true: ' . $topic3);
}
