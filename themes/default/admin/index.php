    ...
    <div class="container-fluid" style="background-color: #181c32;">
        <nav class="container navbar py-0" style="height: 70px;">
            ...
            <div class="ml-auto">
                ...
                <a class="btn fw-700 fs-sm" href="/?p=admin.index&w=atoken/admin-atoken-setting"><?= ln(['en' => 'Token Setting', 'ko' => '토큰 설정']) ?></a>
                ...
                <a class="btn fw-700 fs-sm" href="/?p=admin.index&w=atoken/admin-atoken-history"><?= ln(['en' => 'Token history', 'ko' => '토큰 기록']) ?></a>
