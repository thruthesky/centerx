...
/**
 * 도메인 별로 특정 국가를 고정하고자할 때, 아래의 목록에 루트 도메인과 국가 코드, 사이트 이름, 홈 화면 이름 등을 추가하면 된다.
 *
 * 예를 들면, philov.com 의 경우, 필리핀 국가로 고정시켜 놓고, philov 사이트에서는 카페 생성할 때에 국가 선택을 보여주지 않는다. 또한 각종 커스터마이징에서 필리핀으로 고정을 시킨다.
 */
define('CAFE_ROOT_DOMAIN', [
    'philov.com' => [
        'countryCode' => 'PH',
        'name' => '필러브',
        'homeButtonLabel' => '홈',
