...
<table class="l-content" width="<?=L_CONTENT?>" cellpadding="0" cellspacing="0">
    <tr valign="top">
        ...
        <td width="<?=L_CENTER?>"><section class="l-center bg-green <?=inHome() ? 'mx-3' : 'ml-3'?>"><?php include theme()->page(); ?></section></td>
        <?php if ( inHome() ) { ?>
            <td width="<?=L_RIGHT?>"><section class="l-right bg-blue mh-1024px"><?php include theme()->file('right'); ?></section></td>
        <?php } ?>
    </tr>
</table>
<?php
