...
class AdvertisementController
{
    ...
    public function settings()
    {
        ...
        return [
            ...
            'maxNoOnGlobalTopBanner' => $adv->maxNoOf(TOP_BANNER, ''),
            'maxNoOnCategoryTopBanner' => $adv->maxNoOf(TOP_BANNER, '.'),
            'maxNoOnGlobalSidebarBanner' => $adv->maxNoOf(SIDEBAR_BANNER, ''),
            'maxNoOnCategorySidebarBanner' => $adv->maxNoOf(SIDEBAR_BANNER, '.'),
            'maxNoOnGlobalSquareBanner' => $adv->maxNoOf(SQUARE_BANNER, ''),
            'maxNoOnCategorySquareBanner' => $adv->maxNoOf(SQUARE_BANNER, '.'),
            'maxNoOnGlobalLineBanner' => $adv->maxNoOf(LINE_BANNER, ''),
            'maxNoOnCategoryLineBanner' => $adv->maxNoOf(LINE_BANNER, '.'),
