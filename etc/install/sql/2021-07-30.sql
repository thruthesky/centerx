...
--
-- Host: mariadb
-- 생성 시간: 21-07-30 11:24
-- 서버 버전: 10.6.3-MariaDB-1:10.6.3+maria~focal
-- PHP 버전: 8.0.3
...
--
-- 테이블 구조 `wc_chat_message`
--

CREATE TABLE `wc_chat_message` (
  `idx` int(10) UNSIGNED NOT NULL,
...
--
-- 테이블의 인덱스 `wc_chat_message`
--
ALTER TABLE `wc_chat_message`
  ADD PRIMARY KEY (`idx`),
  ADD KEY `userIdx_otherUserIdx` (`userIdx`,`otherUserIdx`);

--
-- 테이블의 인덱스 `wc_chat_room`
--
ALTER TABLE `wc_chat_room`
  ADD PRIMARY KEY (`idx`);
...
ALTER TABLE `wc_posts` ADD FULLTEXT KEY `title_content` (`title`,`content`);
...
--
-- 테이블의 AUTO_INCREMENT `wc_chat_message`
--
ALTER TABLE `wc_chat_message`
  MODIFY `idx` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 테이블의 AUTO_INCREMENT `wc_chat_room`
--
ALTER TABLE `wc_chat_room`
  MODIFY `idx` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
