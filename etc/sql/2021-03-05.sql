...
CREATE TABLE `wc_categories` (
                                 ...
                                 `list_on_view` char(1) NOT NULL DEFAULT 'Y',
                                 `no_of_posts_per_page` smallint(5) UNSIGNED NOT NULL DEFAULT 20,
                                 `mobile_forum_list_widget` varchar(64) NOT NULL DEFAULT '',
                                 `mobile_forum_view_widget` varchar(64) NOT NULL DEFAULT '',
                                 `forum_edit_widget` varchar(64) NOT NULL DEFAULT '',
                                 `forum_view_widget` varchar(64) NOT NULL DEFAULT '',
                                 `forum_list_header_widget` varchar(64) NOT NULL DEFAULT '',
                                 `forum_list_widget` varchar(64) NOT NULL DEFAULT '',
                                 `pagination_widget` varchar(64) NOT NULL DEFAULT '',
                                 `no_of_pages_on_nav` tinyint(64) UNSIGNED NOT NULL DEFAULT 10,
