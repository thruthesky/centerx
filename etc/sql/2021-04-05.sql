...
--
-- Host: mariadb
-- Generation Time: Apr 05, 2021 at 09:08 AM
...
CREATE TABLE `wc_countries` (
                                ...
                                `ISONumbericCode` smallint(6) UNSIGNED NOT NULL,
...
--
-- Table structure for table `wc_friends`
--
...
--
-- AUTO_INCREMENT for table `wc_friends`
--
ALTER TABLE `wc_friends`
    MODIFY `idx` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
