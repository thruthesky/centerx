...
define('phpThumbConfigFileVersion', '1.7.17-202102131808');
ob_start();
...
$PHPTHUMB_CONFIG['high_security_password']      = '000000,*~,*oo)ohash123';      // required if 'high_security_enabled' is true, and must be at complex (uppercase, lowercase, numbers, punctuation, etc -- punctuation is strongest, lowercase is weakest; see PasswordStrength() in phpthumb.functions.php). You can use a password generator like http://silisoftware.com/tools/password-random.php to generate a strong password
